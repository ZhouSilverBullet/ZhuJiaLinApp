package com.sdxxtop.ui.photoselector;
...
//                RoundedCorners roundedCorners= new RoundedCorners(UIUtils.dip2px(5));
//                RequestOptions requestOptions = RequestOptions.bitmapTransform(roundedCorners);
//                Glide.with(mContext).load(bitmap).apply(requestOptions).into(horImg);
            }
