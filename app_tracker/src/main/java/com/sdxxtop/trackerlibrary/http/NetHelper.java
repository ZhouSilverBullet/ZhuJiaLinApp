...
public class NetHelper {
    ...
    public static String getBase64Data(Map<String, String> map) {
        ...
        map.put("v", Tracker.getInstance().getVersionCode());
        ...
        map.put("sn", md5(sb.toString() + Tracker.getInstance().getAppKey()).toUpperCase());
        for (String key : map.keySet()) {
            LogUtil.d("LOG", "key  " + key + "  value  " + map.get(key));
        }
