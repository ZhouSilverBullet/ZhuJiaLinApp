...
import com.sdxxtop.trackerlibrary.db.DaoSession;

public class DaoManager {
    private Context mContext;

    //创建数据库的名字
    private static final String DB_NAME = "zhidian_parent_tracker.db";
    ...
    public DaoMaster getDaoMaster() {
        if (mDaoMaster == null) {
            mHelper = new UpgradeDevOpenHelper(mContext, DB_NAME, null);
