...
public class DownloadDialog {
     ...
     * @param context
     * @param dataEntity
     * @param downloadIcon  下载时的图片资源显示
     * @param rxPermissions
     */
    public DownloadDialog(Context context, InitData dataEntity, @DrawableRes int downloadIcon, RxPermissions rxPermissions) {
    ...
    private void showProgressDownload() {
        DownloadAppDialog downloadAppDialog = new DownloadAppDialog(context,mDownloadIcon, apkUrl, appPath, dialog);
