package com.sdxxtop.common.dialog.download;
...
public class DownloadAppDialog implements DialogInterface.OnKeyListener {
    ...
    DownloadAppDialog(Context context, @DrawableRes int downloadIcon, String apkUrl, String appPath, Dialog dialog) {
        this.context = context;
        mDownloadIcon = downloadIcon;
        this.apkUrl = apkUrl;
    ...
    public void show() {
        ...
        ImageView ivLoadIcon = (ImageView) downloadDialog.findViewById(R.id.iv_load_icon);
        ivLoadIcon.setImageResource(mDownloadIcon);
    ...
    private boolean checkFile(long contentLength) {
        ...
        if (file.exists()) {
            if (file.length() == contentLength) {
                ...
                SystemUtil.installApk(context, apkPath, CommonSession.AUTHORITY);
                dismiss();
                return true;
            } else {
                if (!file.delete()) {
